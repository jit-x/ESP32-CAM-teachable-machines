...
const char* appassword = "ESP32-passwd";         
...
void setup() {
  ...
  startCameraServer(); 
    ...
    //Define Pin as output Here! ~  
}

void loop() {

if(P1=="Class 1"){
  //P1 stand for the class that is to be read! The class name should be exatly same as that of techable machines! ~
  Serial.println("You are dected...");
  }
                    ...
                    <nav id="menu">
                        <div class="input-group">
                          ...
                          <select id="kind">
                            ...
                            //To select pose instead of image just write pose instead of image and image instead of pose (just in the line numbers 635 and 636)! ~
                          </select>
                        </div>
                        <div class="input-group" style="display:none;">
                          <label for="modelPath">Model Path</label>
                          <input type="text" id="modelPath" value=https://teachablemachine.withgoogle.com/models/XXXXXXXXX/>  //Give the link of your teachable machine!
                        </div>
                        <div class="input-group" style="display:none;">
